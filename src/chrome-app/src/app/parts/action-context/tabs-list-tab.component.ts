...
@Component({
  ...
  template: `
    <div
      class="tab group flex items-center px-3 py-1.5 rounded-lg select-none text-white font-sans text-sm transition-colors duration-200 hover:bg-white/5"
      [ngClass]="{
        'bg-white/15 hover:bg-white/30': isActive(),
      }"
      (click)="onSelectTab()"
    >
