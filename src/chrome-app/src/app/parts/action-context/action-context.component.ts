...
import WorkspaceSwitcherComponent from '../workspaces/workspace-switcher.component';

@Component({
  selector: 'action-context',
  imports: [TabsListComponent, DownloadsListComponent, WorkspaceSwitcherComponent],
  template: `
    <div class="flex flex-col h-full">
      <tabs-list class="flex-shrink-0"></tabs-list>
      <div class="flex-1 flex flex-col justify-end">
        <downloads-list class="flex-shrink-0"></downloads-list>
        <workspace-switcher class="flex-shrink-0"></workspace-switcher>
      </div>
    </div>
  `,
  styles: `
